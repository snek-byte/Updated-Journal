...
# Recreate the noise.ts file in the new environment
output_dir = Path("/mnt/data/src/lib")
output_dir.mkdir(parents=True, exist_ok=True)
noise_file = output_dir / "noise.ts"

wrapped_code = """
/*
 * Adapted from noisejs by Joseph Gentle
 * Converted for ES Module usage in Vite/TypeScript
 */
...
noise_file.write_text(wrapped_code)
